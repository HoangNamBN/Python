...
# in a person's face
FACIAL_LANDMARK_PREDICTOR = 'weights/shape_predictor_68_face_landmarks.dat'
...
def predict_age(input_path: str):
    ...
    for idx, face in enumerate(faces):
        print("Detection Face ID = {} - Position = Left:{} Top:{} Right:{} Botton:{}".format((idx + 1), face.left(),
                                                                                             face.top(), face.right(),
                                                                                             face.bottom()))
...
if __name__ == '__main__':
    ...
    predict_age("homework/codeQuan/images/Donald Trump2.jpg")
