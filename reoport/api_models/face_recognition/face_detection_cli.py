...
import os
import re
import api_models.face_recognition.api as face_recognition
...
@click.option('--upsample', default=0, help='How many times to upsample the data looking for faces. Higher numbers find smaller faces.')
